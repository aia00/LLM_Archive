...
DATASET_NAME=${DATASET_NAME:-"DigitalLearningGmbH/MATH-lighteval"}
...
TRAIN_OUT=${TRAIN_OUT:-"${DATA_DIR}/math_full_train.parquet"}
EVAL_OUT=${EVAL_OUT:-"${DATA_DIR}/math_full_val.parquet"}
