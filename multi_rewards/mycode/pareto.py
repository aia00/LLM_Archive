...
class ParetoBuffer:
    ...
    def __post_init__(self):
        self._front: List[Tuple[float, float, float]] = []
    ...
    def add(self, point: Sequence[float]) -> bool:
        ...
        updated = False
        new_front: List[Tuple[float, float, float]] = []
