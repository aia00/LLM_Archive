...
@hydra.main(config_path='configs', config_name='vicuna_tqa_0.yaml', version_base='1.3')
def main(cfg:DictConfig):
    ...
    for chunk_id in pbar:
        ...
        for i, question in enumerate(questions_chunk):
            ...
            vicuna_prompt = f'Follow this pattern:\n'
            
            for index, row in random_rows.iterrows():
                vicuna_prompt += f"Q: {row['Question']}\nA: {row['Answer']}\n"
            ...
            full_prompt = vicuna_prompt + f"Q: {question}?\nA:"
            # print(full_prompt)
